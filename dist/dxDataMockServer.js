...
},{"../util/constant.js":15,"../util/util.js":16,"dxLog":"dxLog","underscore":"underscore"}],2:[function(require,module,exports){
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at
...
/*
 * Defines a set of general purpose filter routines. These can be used to build type-specific filters.
 *
...
function FilterUtil() {
    ...
    self.checkSameProps = checkSameProps;
...
function checkSameProps(properties, qParams, model) {
    var result = CONSTANT.FILTER_RESULT.INCLUDE;
    
    _.each(properties, function(property) {
       if (_.has(qParams, property) && qParams[property] !== model.get(property)) {
           result = CONSTANT.FILTER_RESULT.EXCLUDE;
       }
    });
...
function checkPageSize(qParams) {
    ...
    return CONSTANT.FILTER_RESULT.INCLUDE;
}
...
function checkDateProp(qParamVal, qParamName, qpSchema, model, attrName) {
    ...
    if (util.isNone(model.get(attrName))) {
        return CONSTANT.FILTER_RESULT.EXCLUDE;
    }
        ...
        currModel.once('ready', function() {
            if (_.isEmpty(pathSegs)) {
                ...
                if (_.contains(DATE_PROPS, qParamName)) {
                    ...
                    result = currModel.get(finalAttrName) === qParamVal ? CONSTANT.FILTER_RESULT.INCLUDE : CONSTANT.FILTER_RESULT.EXCLUDE;
                }

                if (result === CONSTANT.FILTER_RESULT.INCLUDE) {
...
function uberFilter(collection, model, resultHandler, skipParams) {
    ...
    if (_.isEmpty(schemaDef.list.parameters)) {
        resultHandler(CONSTANT.FILTER_RESULT.INCLUDE);
    }
    ...
    if (_.has(listParams, 'pageSize') && collection instanceof Backbone.Collection) {
        ...
        if (pageSizeResult === CONSTANT.FILTER_RESULT.UNKNOWN) {
    ...
    if (_.isEmpty(qParams)) {
        return resultHandler(CONSTANT.FILTER_RESULT.INCLUDE);
    }
    ...
    $.when.apply(undefined, promises)
        ...
        .fail(function() {
            resultHandler(CONSTANT.FILTER_RESULT.EXCLUDE);
        });
}

module.exports = FilterUtil;

},{"../util/constant.js":15,"../util/util.js":16,"dxLog":"dxLog","underscore":"underscore"}],3:[function(require,module,exports){
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at
...
},{"../util/util.js":16,"dxLog":"dxLog","underscore":"underscore"}],4:[function(require,module,exports){
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at
...
},{"../util/constant.js":15,"../util/util.js":16,"./FilterUtil.js":2,"dxLog":"dxLog","underscore":"underscore"}],5:[function(require,module,exports){
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at
...
},{"../util/constant.js":15,"../util/util.js":16,"./FilterUtil.js":2,"dxLog":"dxLog","underscore":"underscore"}],6:[function(require,module,exports){
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at
...
},{"../util/util.js":16,"dxLog":"dxLog","underscore":"underscore"}],7:[function(require,module,exports){
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at
...
},{"../layer1/schema.js":1,"../layer2/FilterUtil.js":2,"../layer2/cache.js":3,"../layer2/collection.js":4,"../layer2/creationListener.js":5,"../layer2/model.js":6,"../util/util.js":16,"./notification.js":8,"dxLog":"dxLog","underscore":"underscore"}],8:[function(require,module,exports){
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at
...
},{"./ServerCore.js":14,"dxLog":"dxLog","underscore":"underscore"}],11:[function(require,module,exports){
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at
...
},{"./AbstractServer.js":10,"dxLog":"dxLog","underscore":"underscore"}],12:[function(require,module,exports){
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at
...
},{"../util/constant.js":15,"../util/util.js":16,"dxLog":"dxLog","underscore":"underscore"}],13:[function(require,module,exports){
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at
...
},{"./AbstractServer.js":10,"dxLog":"dxLog","underscore":"underscore"}],14:[function(require,module,exports){
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at
...
},{"./MockFilterUtils.js":12,"dxLog":"dxLog","underscore":"underscore"}],15:[function(require,module,exports){
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at
...
},{"../layer3/api.js":7,"../util/constant.js":15}],"dxLog":[function(require,module,exports){
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at

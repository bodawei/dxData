...
/*global dx, jasmine, describe, it, expect, beforeEach, spyOn, $, afterEach */
...
describe("dx.core.data._cache", function () {
    ...
    describe("dumpText()", function() {
        it("reports nothing the contents of the cache when called", function() {
            var lines = "";
    ...
    describe("SubcribersStore", function() {
        ...
        beforeEach(function() {
            ...
            creationListener = makeNotificationListener();

...
dx.namespace("dx.core.data.notification");
...
/*
 * If the call fails, we don't want to spin in a loop retrying. We will attempt a new request after this time period.
 */
var RETRY_SEC = 10;

dx.core.data._setupNotification = function(context) {
    ...
    function processNotifications(notifications) {
         ...
         * create, update and delete notification for an object, we will only keep the delete.  This assumes that we never
         * get a non-delete notification after getting a delete notification.
         */
